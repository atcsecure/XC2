...
extern void EnsureWalletIsUnlockedForMinting();
...
extern json_spirit::Value distmix(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value simpledistmix(const json_spirit::Array& params, bool fHelp);
