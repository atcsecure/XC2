...
static void NotifyDistmixPaymentStatusChanged(ClientModel * clientmodel, const std::string & status)
{
    QMetaObject::invokeMethod(clientmodel, "paymentStatusChanged", Qt::QueuedConnection,
...
void ClientModel::subscribeToCoreSignals()
{
    ...
    uiInterface.NotifyDistmixPaymentStatusChanged.connect(boost::bind(NotifyDistmixPaymentStatusChanged, this, _1));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.NotifyDistmixPaymentStatusChanged.disconnect(boost::bind(NotifyDistmixPaymentStatusChanged, this, _1));
}
