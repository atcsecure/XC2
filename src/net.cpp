...
static const char *strDNSSeed[][2] = {
	...
	{"d2hc6in7jaczu3av.onion", "d2hc6in7jaczu3av.onion"},  
	{"qwr3je6njcwvo2rw.onion", "qwr3je6njcwvo2rw.onion"}, 
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XCurrency is probably already running."), addrBind.ToString().c_str());
        else
